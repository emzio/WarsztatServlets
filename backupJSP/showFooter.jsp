...
<!--moje-->
<%--                    <form action="/postrRedirect" method="post">--%>
<%--                        <fieldset>--%>
...
<%--                            <input type="checkbox" name="hobby" value="computers" id="computers">--%>
<%--                            <label for="computers"> Komputery </label>--%>
<%--                            <input type="checkbox" name="hobby" value="animals" id="animals">--%>
